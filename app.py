...
ELEMENTS = {
    1: {"title": "تعزيز القيم الإسلامية والهوية الوطنية", "witnesses": ["تُذاع إذاعة مدرسية صباحية تتضمن فقرة عن قصة وطنية أو قيمة إسلامية أسبوعياً", "ينظم المعلم مسابقة داخل الصف عن أسماء ملوك أو قادة البلاد", "يردد المتعلمون النشيد الوطني باحترام ووقوف في طابور الصباح", "يذكر المعلم مناسبات وطنية (مثل اليوم الوطني) وينفذ نشاطاً فنياً عنها", "يروي المعلم قصة قصيرة عن تضحيات رجال الأمن أو الجيش للمحافظة على الوطن", "يكتب المتعلمون عبارات تعبر عن حب الوطن على لوحة الإعلانات الصفية", "تُعرض في المدرسة صور أو رسومات تعبر عن القيم الإسلامية (الصدق، الأمانة، التعاون)"]},
    2: {"title": "مناخ آمن للتعلم", "witnesses": ["يلتزم المعلم بعدم استخدام أي عبارات سخرية أو تنميط تجاه المتعلمين", "تُطبق المدرسة نظام إحالة للحالات النفسية إلى المرشد خلال 24 ساعة", "يشعر المتعلمون بالأمان عند التعبير عن رأيهم دون خوف من العقاب", "يتوفر في الصف جدار للتواصل (اقتراحات، شكاوى) يكتب فيه المتعلمون بحرية", "يعرف المتعلمون مكان المرشد الطلابي ويسهل الوصول إليه", "يلاحظ المراقب غياب التنمر اللفظي أو الجسدي بين المتعلمين", "يطبق المعلم خطة إخلاء واضحة عند الطوارئ ويدرب المتعلمين عليها"]},
    3: {"title": "مصادر وأنشطة متنوعة تلبي احتياجات المتعلمين", "witnesses": ["يتوفر في الصف كتاب بطريقة برايل أو نسخ إلكترونية صوتية لذوي الإعاقة البصرية", "يخصص المعلم مهام إثرائية إضافية للمتعلمين الموهوبين", "يُستخدم جهاز تضخيم الصوت أو سماعات للمتعلمين ضعاف السمع", "تتوفر أوراق عمل بخط كبير ومبسط لذوي صعوبات التعلم", "يُتاح للمتعلم ذي الإعاقة الحركية مكان جلوس مناسب بالقرب من المدخل", "يوظف المعلم سبورة تفاعلية أو أجهزة لوحية لتنوع المصادر", "تُقدم أنشطة حركية أو حسية تناسب مختلف أنماط التعلم"]},
    4: {"title": "إدارة الوقت بفاعلية", "witnesses": ["يخصص المعلم 5 دقائق إضافية للطالب ذي الإعاقة الحركية لإنهاء النشاط الكتابي", "يوزع المعلم وقت الحصة بوضوح (تمهيد 5 د، عرض 15 د، تطبيق 10 د، ختام 5 د)", "يُعطى المتعلمون إشارات زمنية (مثل: تبقى 3 دقائق) لتنظيم عملهم", "ينتهي المعلم من الأنشطة قبل نهاية الحصة بوقت كاف لإعطاء التغذية الراجعة", "ينتقل المعلم بين الأنشطة بسلاسة دون وقت ضائع في التنظيم أو التوجيه", "يراعى وقت الحصة عند تصميم الأنشطة بحيث لا تطول أو تقصر عن المطلوب", "يُتاح وقت إضافي للموهوبين لاستكشاف موضوع أعمق والضعفاء لإنجاز الأساسيات"]},
    5: {"title": "فرص متكافئة في الأنشطة والمناقشة", "witnesses": ["يدعو المعلم المتعلمين بالتبادل عبر بطاقات الأسماء، وليس فقط من يرفع يده أولاً", "يسمح المعلم للمتعلمين في الخلف أو الأطراف بالمشاركة بقدر من في المقدمة", "تتنقل المعلمة بين جميع المجموعات بالتساوي أثناء الأنشطة الجماعية", "يُتيح الجهاز اللوحي أو الكمبيوتر لجميع المتعلمين بالتناوب وليس لشخص واحد", "تُوزع أدوات التعلم (سبورة، أقلام، مجسمات) بالعدل دون تمييز", "يحرص المعلم على توجيه أسئلة للإناث والذكور وللطلاب ذوي المستويات المختلفة", "يتاح للجميع الاقتراب من السبورة أو المجسم لعرض أفكارهم"]},
    6: {"title": "مصادر تعلم متنوعة تدعم المناهج", "witnesses": ["توجد في المدرسة مجسمات، خرائط، أدوات معمل، وقصص رقمية توازي كل وحدة دراسية", "تتوفر مكتبة صفية تحتوي على مراجع إضافية للبحث والاستزادة", "يستخدم المعلم أجهزة عرض البيانات (داتاشو) لعرض فيديوهات تعليمية", "يُمكن الوصول إلى منصة تعليمية رقمية (مثل Classroom، Teams) تحتوي على محتوى المنهج", "تُوفر المدرسة أقراصاً تعليمية أو كتباً إلكترونية لجميع المواد", "يوجد في الصف وسائل تعليمية يدوية الصنع من إعداد المعلم أو المتعلمين", "تتنوع المصادر بين سمعية وبصرية وملموسة ورقمية لتغطية كل نواتج التعلم"]},
    7: {"title": "أنشطة واستراتيجيات تدريس تحقق نواتج التعلم", "witnesses": ["يكتب المعلم ناتج التعلم على السبورة، ثم يصمم نشاطاً يثبت هذا الناتج", "يرتبط كل نشاط يقوم به المتعلمون بشكل مباشر بهدف الحصة", "في نهاية الحصة، يستطيع المتعلم التعبير عما تعلمه بنفس لفظ ناتج التعلم", "لا يوجد نشاط في الحصة خارج نطاق نواتج التعلم المعلنة", "يُقيّم المعلم مدى تحقيق النشاط لناتج التعلم بشكل علني", "تتنوع الأنشطة لتحقيق أبعاد مختلفة من نواتج التعلم (معرفي، مهاري، وجداني)", "يعيد المعلم صياغة ناتج التعلم بلغة المتعلمين قبل بدء النشاط"]},
    8: {"title": "تنوع استراتيجيات التدريس وفق قدرات المتعلمين", "witnesses": ["يوجه المعلم سؤالاً مختلفاً لكل مجموعة (حفظ للمبتدئين، فهم للمتوسطين، تطبيق للمتفوقين)", "يستخدم المعلم أكثر من استراتيجية في الحصة الواحدة (حوار، لعب أدوار، عمل جماعي، عصف ذهني)", "يُقدم النشاط الواحد بطريقتين (كتابي وشفهي أو يدوي ورقمي) لمراعاة الفروق", "يسمح المعلم للمتعلم السريع بالانتقال إلى نشاط إضافي بينما يتابع البقية", "يُلحق المعلم مهام داعمة للضعفاء ومهام توسعة للمتفوقين بنفس الدرس", "يراعي المعلم الفروق في طريقة الشرح (بصري، سمعي، حركي) خلال الحصة", "يغير المعلم شكل المجموعات (ثنائية، فردية، جماعية) حسب قدرات المتعلمين"]},
    9: {"title": "استخدام مصادر تعلم رقمية", "witnesses": ["يوظف المعلم رابط فيديو قصيراً + لعبة تفاعلية (مثل Kahoot أو Quizizz) في الحصة", "يتيح المعلم خيار القراءة الرقمية أو الورقية حسب رغبة المتعلم", "يستخدم المعلم السبورة التفاعلية لعرض الصور والمقاطع المرئية", "يوفر المعلم تطبيقاً تعليمياً على الجهاز اللوحي يسمح باختيار مستوى الصعوبة", "يعرض المعلم محاكاة رقمية (محاكي) لتجربة علمية بدلاً من المجسمات التقليدية", "يستخدم المعلم رمز QR سريعاً للوصلة إلى مصدر إضافي للطلاب المتقدمين", "يتيح المعلم لذوي صعوبات القراءة الاستماع إلى النص عبر مكبر الصوت"]},
    10: {"title": "تطبيقات عملية مرتبطة بحياة المتعلمين", "witnesses": ["ينفذ المتعلمون محاكاة لشراء السلع باستخدام حسابات النسبة المئوية للخصم", "يطلب المعلم من المتعلمين إحصاء عدد زملائهم في الصف كتطبيق على عملية الجمع", "يصمم المتعلمون جدولاً لحصصهم الأسبوعية باستخدام برنامج إلكتروني", "يكتب المتعلمون رسالة شكر لأحد العمال في المدرسة (تطبيق على فن الكتابة)", "يحسب المتعلمون استهلاك الماء أو الكهرباء في المنزل ضمن مادة العلوم", "ينفذ المعلم نشاط إعادة تدوير علب الكرتون ضمن مادة التربية الفنية", "يطبق المتعلمون آداب الحوار أثناء مناقشة مشكلة حقيقية في الصف (مثل تأخر الواجبات)"]},
    11: {"title": "تنمية مهارات القراءة والكتابة", "witnesses": ["يقرأ كل متعلم فقرة بصوت منخفض، ثم يكتب تعليقاً من سطرين في دفتر التفاعل", "تتوفر في ركن القراءة كتب قصصية وقصائد ومجلات مناسبة لأعمارهم", "يكتب المتعلمون تلخيصاً يومياً للحصة في جملتين في نهاية اليوم", "ينظم المعلم مسابقة إملاء أو قراءة سريعة بين المجموعات", "يخصص المعلم 10 دقائق أسبوعياً للقراءة الحرة يليها تسجيل في سجل القراءة", "تُعرض على جدار الصف جمل أو فقرات أسبوعية يقرؤها المتعلمون عند الدخول", "يستخدم المعلم بطاقات الكلمات لتدريب المتعلمين الضعفاء على القراءة"]},
    12: {"title": "تنمية المهارات العددية (الحساب)", "witnesses": ["يستخدم المعلم عدادات رقمية أو مكعبات صغيرة لحل مسائل الجمع والطرح يومياً", "يبدأ المعلم الحصة بمسألة حسابية قصيرة على السبورة يحلها الجميع", "يتوفر في الصف ركن الرياضيات يحتوي على مجسمات هندسية وأعداد", "يطلب المعلم من المتعلمين حساب عدد الطلاب الحاضرين والغائبين شفوياً", "يستخدم المعلم أسئلة سريعة (مثل: كم ربعاً في الواحد الصحيح؟) يومياً", "ينظم المعلم لعبة بنك الأرقام (تجميع بطاقات الأرقام لإكمال معادلة)", "يستخدم المتعلمون السبورة الصغيرة لحل مسائل الحساب الذهني وتصحيحها جماعياً"]}
}
...
def init_local_db():
    conn = sqlite3.connect(DB_PATH)
    c = conn.cursor()
    c.execute('''CREATE TABLE IF NOT EXISTS users (id INTEGER PRIMARY KEY AUTOINCREMENT, username TEXT UNIQUE, password TEXT, full_name TEXT)''')
    c.execute('''CREATE TABLE IF NOT EXISTS evidences (id INTEGER PRIMARY KEY AUTOINCREMENT, username TEXT, element_id INTEGER, element_title TEXT, witness_id INTEGER, witness_text TEXT, image_path TEXT, image_url TEXT, synced INTEGER DEFAULT 0, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP)''')
    users = [
...
def upload_to_supabase(image_bytes, filename):
    ...
    try:
        ...
        if response.status_code in [200, 201]:
            return f"{SUPABASE_URL}/storage/v1/object/public/evidence/{filename}"
    except Exception as e:
...
def sync_to_supabase():
    ...
    for row in rows:
        try:
            ...
            data = {'username': row[1], 'element_id': row[2], 'element_title': row[3], 'witness_id': row[4], 'witness_text': row[5], 'image_url': image_url or row[6], 'created_at': row[7] if len(row) > 7 else datetime.now().isoformat()}
            response = requests.post(f"{SUPABASE_URL}/rest/v1/evidences", headers=headers, json=data)
            if response.status_code in [200, 201]:
...
def sync_from_supabase():
    ...
    try:
        response = requests.get(f"{SUPABASE_URL}/rest/v1/evidences", headers=headers)
        if response.status_code == 200:
            ...
            for item in data:
                ...
                if not c.fetchone():
                    c.execute('''INSERT INTO evidences (username, element_id, element_title, witness_id, witness_text, image_url, synced) VALUES (?, ?, ?, ?, ?, ?, 1)''', (item['username'], item['element_id'], item['element_title'], item['witness_id'], item['witness_text'], item.get('image_url', '')))
            conn.commit()
            conn.close()
...
<style> *{margin:0;padding:0;box-sizing:border-box}body{font-family:'Segoe UI',sans-serif;background:linear-gradient(135deg,#1a2a6c,#b21f1f,#fdbb4d);min-height:100vh;display:flex;justify-content:center;align-items:center} .login-container{background:rgba(255,255,255,0.95);border-radius:20px;padding:40px;width:90%;max-width:400px;box-shadow:0 25px 45px rgba(0,0,0,0.2)} .logo{text-align:center;font-size:64px;margin-bottom:20px} h1{text-align:center;color:#333;margin-bottom:30px} input{width:100%;padding:14px;margin:10px 0;border:2px solid #e0e0e0;border-radius:10px;font-size:16px;transition:0.3s} input:focus{border-color:#667eea;outline:none} button{width:100%;padding:14px;background:linear-gradient(135deg,#667eea,#764ba2);color:white;border:none;border-radius:10px;font-size:18px;font-weight:bold;cursor:pointer;transition:0.3s} button:hover{transform:translateY(-2px);box-shadow:0 5px 15px rgba(0,0,0,0.2)} .error{background:#fee;color:#c00;padding:10px;border-radius:8px;margin-top:15px;text-align:center;display:none} .info{text-align:center;margin-top:25px;color:#666;font-size:14px} </style>
</head>
<body>
...
.sidebar{position:fixed;right:0;top:0;width:260px;height:100%;background:linear-gradient(180deg,#1a2a6c,#b21f1f);color:white;padding:20px;box-shadow:-2px 0 10px rgba(0,0,0,0.1);z-index:100;transition:0.3s}
...
.main-content{margin-right:260px;padding:20px;min-height:100vh;transition:0.3s}
...
.capture-btn{background:#28a745;color:white;padding:12px;border:none;border-radius:10px;margin-top:15px;width:100%;cursor:pointer;transition:0.2s}
...
.history-card{background:white;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.1);transition:0.3s}
.history-card:hover{transform:translateY(-3px);box-shadow:0 4px 15px rgba(0,0,0,0.15)}
.history-card img{width:100%;height:180px;object-fit:cover}
#menuToggleBtn{background:#667eea;color:white;border:none;border-radius:8px;padding:10px 15px;font-size:16px;cursor:pointer;margin-left:10px}
...
<div class="nav-item active" onclick="showSection('dashboard');toggleSidebar()">📋 لوحة التوثيق</div>
<div class="nav-item" onclick="showSection('stats');toggleSidebar()">📊 إحصائياتي</div>
<div class="nav-item" onclick="showSection('history');toggleSidebar()">🖼️ توثيقاتي السابقة</div>
<button class="logout-btn" onclick="logout()">🚪 تسجيل خروج</button></div>
<div class="main-content">
<div style="display:flex; align-items:center; margin-bottom:10px;"><button id="menuToggleBtn">☰ القائمة</button></div>
<div class="header"><h2>مرحباً <span id="usernameDisplay">{{ username }}</span></h2><div>📅 <span id="dateDisplay"></span></div></div>
...
function displayElements(){
    ...
    for(const[id,element]of Object.entries(elements)){
        ...
        element.witnesses.forEach((text,idx)=>{
            ...
            div.innerHTML=`<span class="witness-text">${idx+1}. ${text.substring(0,100)}${text.length>100?'...':''}</span><span class="camera-icon" onclick="openCamera(${id},${idx+1})">📷</span>`;
...
async function openCamera(elementId,witnessId){
    ...
    try{
        ...
        try{
            ...
            document.getElementById('video').srcObject=stream;
        }catch(e){alert('لا يمكن الوصول إلى الكاميرا: '+e.message);}
    }
}
...
async function capturePhoto(){
    ...
    }else{alert('❌ لم يتم التقاط الصورة، تأكد من تشغيل الكاميرا');}
}
...
function switchCamera(){
    if(currentFacingMode==='environment'){currentFacingMode='user';}else{currentFacingMode='environment';}
    if(stream){stream.getTracks().forEach(track=>track.stop());}
    navigator.mediaDevices.getUserMedia({video:{facingMode:{exact:currentFacingMode}}}).then(newStream=>{stream=newStream;document.getElementById('video').srcObject=newStream;}).catch(err=>{navigator.mediaDevices.getUserMedia({video:true}).then(fallbackStream=>{stream=fallbackStream;document.getElementById('video').srcObject=fallbackStream;currentFacingMode='environment';}).catch(e=>{alert('لا يمكن تبديل الكاميرا: '+e.message);});});
}
...
function gregorianToHijri(date){
    ...
    return new Intl.DateTimeFormat('ar-TN-u-ca-islamic',{year:'numeric',month:'long',day:'numeric'}).format(gDate);
}
...
function toggleSidebar(){
    ...
    if(sidebar.style.display==='none'){sidebar.style.display='block';document.querySelector('.main-content').style.marginRight='260px';}
    else{sidebar.style.display='none';document.querySelector('.main-content').style.marginRight='0px';}
}
...
.btn{padding:10px 20px;border:none;border-radius:8px;cursor:pointer;font-size:14px;margin-left:10px;margin-bottom:10px}
.btn-primary{background:#667eea;color:white}
.btn-success{background:#28a745;color:white}
.btn-danger{background:#dc3545;color:white}
.btn-warning{background:#ffc107;color:#333}
.btn-info{background:#17a2b8;color:white}
table{width:100%;background:white;border-radius:15px;overflow:hidden;margin-top:20px}
...
<div id="allSection"><div><button class="btn btn-primary" onclick="exportCSV()">📥 تصدير CSV</button><button class="btn btn-primary" onclick="refreshData()">🔄 تحديث</button></div>
...
<div id="usersSection" style="display:none;"><div><button class="btn btn-success" onclick="showAddUserModal()">➕ إضافة مستخدم</button><button class="btn btn-primary" onclick="loadUsers()">🔄 تحديث</button></div>
<div style="overflow-x:auto;"><table><thead><tr><th>#</th><th>اسم المستخدم</th><th>الاسم الكامل</th><th>النوع</th><th>الإجراءات</th></tr></thead><tbody id="usersTableBody"></tbody></table></div></div>
<div id="syncSection" style="display:none;"><div><button class="btn btn-primary" onclick="syncToCloud()">☁️ مزامنة إلى السحابة</button><button class="btn btn-success" onclick="syncFromCloud()">📥 جلب من السحابة</button></div>
<div id="syncStatus" style="background:#e9ecef;padding:10px;border-radius:8px;margin-top:15px;display:none;"></div>
<div style="background:white;border-radius:15px;padding:20px;margin-top:20px;"><h4>ℹ️ حول المزامنة</h4><p>• "مزامنة إلى السحابة": رفع التوثيقات المحلية إلى Supabase</p><p>• "جلب من السحابة": تحميل التوثيقات من Supabase إلى الجهاز</p></div></div></div>
<div id="addUserModal" class="modal"><div class="modal-content"><h3>➕ إضافة مستخدم</h3><input type="text" id="newUsername" placeholder="اسم المستخدم" required><input type="text" id="newFullName" placeholder="الاسم الكامل"><input type="password" id="newPassword" placeholder="كلمة السر" value="pass123"><div class="modal-buttons"><button class="btn btn-success" onclick="addUser()">إضافة</button><button class="btn btn-danger" onclick="closeAddUserModal()">إلغاء</button></div></div></div>
...
async function refreshData(){
    ...
    if(data.success){
        ...
        if(allData.length===0){tbody.innerHTML='<tr><td colspan="6" style="text-align:center;">لا توجد توثيقات</td></tr>';}
        else{tbody.innerHTML=allData.map((item,i)=>`<tr><td>${i+1}</td><td>${item.username}</td><td>العنصر ${item.element_id}</td><td>${item.witness_text.substring(0,40)}...</td><td>${item.image_path?'✅':'❌'}</td><td>${new Date(item.created_at).toLocaleDateString('ar-SA')}</td></tr>`).join('');}
    }
}
async function loadUsers(){
    ...
    if(data.success){
        ...
        tbody.innerHTML=data.data.map((user,i)=>`<tr><td>${i+1}</td><td>${user.username}</td><td>${user.full_name||'-'}</td><td>${user.username==='admin'?'مدير':'مراقب'}</td><td>${user.username!=='admin'?`<button class="btn btn-warning" onclick="showEditUserModal(${user.id},'${user.username}','${user.full_name||''}')" style="margin:2px;">✏️</button><button class="btn btn-danger" onclick="deleteUser(${user.id},'${user.username}')" style="margin:2px;">🗑️</button><button class="btn btn-info" onclick="resetPassword(${user.id})" style="margin:2px;">🔑</button>`:'لا يمكن تعديل'}</td></tr>`).join('');
    }
}
...
function showEditUserModal(id,username,full_name){currentEditId=id;document.getElementById('editUserId').value=id;document.getElementById('editFullName').value=full_name||'';document.getElementById('editPassword').value='';document.getElementById('editUserModal').style.display='flex';}
function closeEditUserModal(){document.getElementById('editUserModal').style.display='none';currentEditId=null;}
...
async function syncToCloud(){
    ...
    const result=await response.json();
    if(result.success){status.innerHTML=`✅ تم المزامنة! ${result.synced} توثيق.`;refreshData();}
...
async function syncFromCloud(){
    ...
    const result=await response.json();
    if(result.success){status.innerHTML=`✅ تم الجلب! ${result.synced} توثيق.`;refreshData();loadUsers();}
...
def save_evidence():
    ...
    conn = sqlite3.connect(DB_PATH)
    c = conn.cursor()
    c.execute('''INSERT INTO evidences (username, element_id, element_title, witness_id, witness_text, image_path, image_url, synced) VALUES (?, ?, ?, ?, ?, ?, ?, ?)''',
