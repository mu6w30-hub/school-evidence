...
ELEMENTS = {
    1: {"title": "الخطة التشغيلية والمتابعة", "witnesses": [
        "١-١-١-١ وجود الخطة التشغيلية / تحليل",
        "١-١-١-٢ تتابع المدرسة / شواهد ما هو موجود وفي الخطة الشهرية المتابعة",
        "استمارة المتابعة",
        "تصاميم إذا وصلوا وحدت",
        "اجتماع إداري لتصميم المتابعة"
    ]},
    2: {"title": "القيم الإسلامية والهوية الوطنية", "witnesses": [
        "١-٢-١-١ القيم الإسلامية والهوية الوطنية",
        "يوم الوطني",
        "يوم التأسيس - يوم المعلم (تقدير المعلم)",
        "انتظار في صفحة التميز بين القيم",
        "شراكة أولياء الأمور",
        "مشاركة الطلاب"
    ]},
    3: {"title": "ميثاق مهنة التعليم واللجان المدرسية", "witnesses": [
        "١-٢-٢-١ اجتماع المعلمين عن ميثاق مهنة التعليم",
        "توقيع المعلمين على الاطلاع على ميثاق مهنة التعليم",
        "زيد عن الميثاق",
        "مشاركة معلمين في اللجان",
        "اللجان المدرسية",
        "تواصل المعلم مع أولياء الأمور",
        "الانضباط الوظيفي (كتاب النشاط)",
        "كلمات الانضباط",
        "المناوبة والإشراف"
    ]},
    4: {"title": "الانضباط المدرسي", "witnesses": [
        "٣-١-٢-١ الانضباط المدرسي",
        "نشرة تثقيفية",
        "السلوك الانضباطي موقع الطلاب",
        "الغياب والتأخير",
        "معالجة التأخر",
        "معالجة الغياب",
        "رسائل الغياب",
        "محاضر هروب من الحصة والخطط العلاجية"
    ]},
    5: {"title": "السلوك الإيجابي", "witnesses": [
        "١-٢-٢-٢ السلوك الإيجابي",
        "تقييم السلوك الإيجابي ٢٠٪",
        "مشاكل الطلاب السلوكية وعلاجها",
        "تعزيز السلوك الإيجابي",
        "ورش عمل للسلوك الإيجابي",
        "حوار الطلاب",
        "اللقاء",
        "برامج وزارية",
        "شهادات شكر",
        "رسائل شكر",
        "برامج غرس القيم الإسلامية"
    ]},
    6: {"title": "خطة النشاط والموهوبين", "witnesses": [
        "٢-١-١-٥ خطة النشاط",
        "حفز الموهوبين (السجل)",
        "الدخول في برنامج الموهوبين",
        "مسابقة الموهوبين",
        "بحوث",
        "مسابقة علمية",
        "دورات تدريبية كإدارة الوقت"
    ]},
    7: {"title": "زيارات المعلمين والطلاب والمشاركة", "witnesses": [
        "١-٢-١-١ زيارة المعلمين والطلاب",
        "سجل زيارات المعلمين",
        "حملة تطوعية لجنة النظام من الطلاب",
        "حوار الطلاب",
        "مشاركة (أنس الطلاب)",
        "مشاركة أكثر من طلاب في مشروع (عمل في مادة علمية)"
    ]},
    8: {"title": "مشاركة الأسرة والشراكة المجتمعية", "witnesses": [
        "مشاركة الأسرة (٢-١-٣-١)",
        "مجلس الآباء",
        "مشاركة للأسرة في الأنشطة الطلابية والعمل",
        "أعمال عند الموجهين (عن بعد)",
        "مشاركة المدرسة في الأيام والمناسبات العالمية",
        "قروب قواعد وأولياء أمور واتس، تليجرام",
        "تواصل مع أولياء في علاج ضعف الطلاب",
        "استبيان رضا المستفيد",
        "مشاركة أولياء الأمور في الجوائز",
        "الشراكة المجتمعية (٢-١-٣-٢)",
        "شراكات مع شركات تجارية",
        "شراكات مع جهات خيرية",
        "خدمة مجتمعية (تطوع) النظام في المدرسة (طلاب)",
        "مساهمة أولياء الأمور في جوائز المدرسة",
        "حملات توعوية للحفاظ على البيئة",
        "نشرات صحية على قروبات المدرسة",
        "درس عمل للمجتمع المحلي"
    ]},
    9: {"title": "الكادر التعليمي والتطوير المهني", "witnesses": [
        "الكادر التعليمي (١-٤-١-١)",
        "بيانات المعلمين",
        "الرخص المهنية",
        "تكاليف المعلمين والمعلمات",
        "تكاليف المعلمين للعضوية",
        "الدورات",
        "شهادات الشكر",
        "وثائق تخرج",
        "مشاركة معلم في إخراج",
        "٢-١-٤-١ نفس السابق",
        "١-٤-١-٣ فريق الميزانية",
        "صندوق الصرف",
        "عقود تجارية",
        "شراكة مجتمعية أولياء الأمور",
        "تكريم الطلاب",
        "تكريم المعلمين",
        "فواتير الصرف",
        "١-٤-١-٤ حث المعلمين على دخول الدورات عبر المنصات",
        "حصر أسماء في سجل تخصص الرخص",
        "حصر الرتب",
        "توفير دورات ورقية - مدرب رئيسي",
        "تكريم الحاصلين على الرخص المهنية",
        "التطوير المهني (٢-٥-٤-١)",
        "سجل النمو المهني",
        "تبادل الزيارات",
        "المجتمع التعليمي",
        "كوت المعلم",
        ...
        "دورات وورش تعلم",
        "الأداء الوظيفي",
        "حصر احتياج المعلمين للتدريب",
        "نواتج التعلم"
    ]},
    10: {"title": "التقويم والتحسين", "witnesses": [
        "١-٤-٢-١ وجود فريق تقويم",
        "سجل التقويم الذاتي",
        "كل لجنة التميز",
        "ورش تدريب الفريق",
        "نشر ثقافة التقويم الذاتي للطلاب",
        "ورش للمعلمين",
        "تقرير التقويم الخارجي",
        "١-٤-١-٧ وضع خطة تحسين",
        "سجل متابعة التنفيذ",
        "شواهد على الخطة"
    ]},
    11: {"title": "التعليم والتعلم وفرص متكافئة", "witnesses": [
        "فرص متكافئة (١٦-١-٢-١)",
        "سجل توزيع الكتب",
        "تنوع أساليب التدريس والأنشطة",
        "مشاركة في الأنشطة",
        "تكريم الطلاب المتفوقين",
        "تكريم الطلاب ذات السلوك الإيجابي",
        "نزاع المسابقات على قروب الواتس التعليمي",
        "وجود أولياء الأمور في التليجرام",
        "لجنة كشوف المتابعة",
        "تدعيم المدرسة (٢-١-١-٢)",
        "سجل متابعة المنصة",
        "خطة الأسبوعية للمعلمين",
        "خطة المنهج",
        "سجل زيارة الإدارة للمعلمين لمطابقة الأمان مع الخطط",
        "تنفيذ توصيات الزائر",
        "سجل الكشوف"
    ]},
    12: {"title": "شواهد المدرسة واستراتيجيات التدريس", "witnesses": [
        "شواهد المدرسة ٢-١-١-٢",
        "دورة من استراتيجيات التدريس",
        "دورة في استخدام التقنية",
        "توفير استراتيجيات للمعلمين",
        "سجل زيارات المعلمين",
        "استمارة توثيق الزيارة",
        "المجتمع التعليمي",
        "الخطط الأسبوعية",
        "٢-١-١-٤ واجبات المنصة",
        "الإثراءات على المنصة",
        "الاختبارات الإلكترونية",
        "ألعاب تعليمية إلكترونية",
        "منصة تميز",
        "استخدام الكتاب",
        "جدول المنصة",
        "سجل متابعة المنصة",
        "مختبرات افتراضية",
        "برامج مسابقات",
        "حصر دخول الطلاب للمنصة – نسبة إنجاز",
        "٢-١-١-٥ تنفيذ أنشطة تعليمية تطبيقية للطلاب",
        "مثل: كواكب الأرض، المجموعة الشمسية، حساب زاوية السقوط",
        "التجارب العملية",
        "مهارات قراءات في الإذاعة",
        "سجل المتابعة"
    ]},
    13: {"title": "دافعية التعلم ومجلس الطلاب", "witnesses": [
        "دافعية التعلم (٢-١-١-٩)",
        "مجلس الطلاب",
        "مشاركة الطلاب في الأنشطة الصيفية",
        "تكليف الطلاب بالمهام القيادية",
        "استمارة قياس رضا الطالب (المعلم)",
        "احتواء الطالب وتقديم الأمان (المناوبة)",
        "المعلم الصغير",
        "أعمال فنية متعلقة بالحياة العملية",
        "التكريم",
        "٢-٢-١-١ استخدام استراتيجيات متنوعة",
        "أوراق عمل - اختبارات إلكترونية - ورقية",
        "مهام أدائية",
        "المعلم الصغير",
        "ألعاب تعليمية",
        "نشر الثقافة بأعمال المدرسة"
    ]},
    14: {"title": "تحليل النتائج ومعالجة الفجوة", "witnesses": [
        "٢-٢-١-٣ تحليل نتائج",
        "نسبة النجاح والرسوب",
        "تحليل توزيع الدرجات حسب المستويات",
        "شواهد تقرير النجاح",
        "معالجة الفجوة",
        "الخطط الإجرائية",
        "٢-٢-١-٤ سجل الكتابة",
        "الكتاب المدرسي والتعليقات",
        "الدفتر",
        "نتائج الاختبارات",
        "مشاركة ولي الأمر",
        "الخطط الأسبوعية",
        "شهادات الشكر والانجاز"
    ]},
    15: {"title": "خطط نافس والاختبارات", "witnesses": [
        "٢-١-١-١ خطط نافس",
        "تنفيذ المعلمين للحصص الداعمة",
        "مجلس الآباء",
        "شواهد الاختبارات المحاكية",
        "شواهد التكريم",
        "٢-١-١ القيم الإسلامية",
        "الخطة التشغيلية المتعلقة",
        "مشاركة الطلاب",
        "الصلاة",
        "أعمال تراثية"
    ]},
    16: {"title": "القراءة والرياضيات والفاقد التعليمي", "witnesses": [
        "٢-٢-١٢ اتجاهات إيجابية",
        "٤-١-١-٣ تقرير من منصة نافس بين السنوات السابقة يوضح مهارات الضعف",
        "رصد فجوة القراءة",
        "اختبارات دورية",
        "خطة معالجة الفاقد القرائي تنفيذ حصص إضافية للمهارات",
        "نادي القراءة توثيق نشاط طلاب للقراءة",
        "مبادرة مسابقة القراءة الذهبية وقت",
        "بطاقة متابعة الطلاب من الضعف إلى الإتقان",
        "تلخيص القصص",
        "شهادة شكر",
        "التحدث في الإذاعة",
        "٢-١-١-٥ رسم منحنى النمو الرياضي",
        "تحليل الفاقد التعليمي",
        "اختبارات محاكية",
        "سجل المجتمعات المهنية",
        "سجل أولمبياد الرياضيات",
        "ملف التربية الرياضية التطبيقية",
        "سجل الدعم التعليمي الفردي",
        "مراجعة خطة التحسين",
        "إحصائية الواجبات الرقمية"
    ]},
    17: {"title": "نتائج نافس والهوية الوطنية", "witnesses": [
        "٢-١-١-١ طباعة نتائج نافس حصر عدد الطلاب الذين حققوا مستوى متقدم",
        "سجل الإلقاء والخطابة",
        "ملفات إنجاز القراءة الرقمية",
        "٣-٢-١١ أداء النشيد الوطني مقاطع فيديو",
        "ارتداء الزي الوطني",
        "لوحات ولاء وانتماء جداريات",
        "بحوث عن رؤية ٢٠٣٠ ومشاريع الرؤية",
        "بطاقة (هويتي وطني)",
        "زيارات المعالم التاريخية",
        "مسابقات الرسم الوطنية",
        "تفعيل المناسبات الوطنية"
    ]},
    18: {"title": "السلوك الإيجابي والممارسات الصحية", "witnesses": [
        "إيجابية (٢-١-٢-٢) مبادرة (شكراً زميلي)",
        "لوحة (مبدع الأسبوع)",
        "ورشة (الحد من التنمر)",
        "حوار الطلاب",
        "استبيان المناخ النفسي",
        "دمج ذوي الإعاقة",
        "٢-٢-١-٢ الممارسات الصحية",
        "تقرير من الوحدة الصحية",
        "الفحص الطبي",
        "مبادرة (ارتقاء)",
        "النشاط الرياضي اليومي",
        "حملة مدينة بلا تدخين",
        "دوري يوم الصحة العالمي",
        "جداريات صحتي في غذائي",
        "حملة لا للسهر",
        "مسابقة أفضل فطور صحي"
    ]},
    19: {"title": "الأعمال التطوعية والسلوك والبيئة المدرسية", "witnesses": [
        "٢-٢-١-٤ الأعمال التطوعية",
        "سجل ساعات التطوع",
        "تطوع الطلاب والمعلمين للمدرسة",
        "مساندة طلاب ذوي الإعاقة",
        "مدرسة نظيفة",
        "امشِ في نفس",
        "المساندة الدراسية",
        "قواعد السلوك (٢-٢-١-٥)",
        "سجل الغياب والتأخير",
        "الانضباط المدرسي",
        "ميثاق الانضباط السلوكي",
        "كل صف في لغات",
        "تعديل السلوك",
        "شهادات شكر",
        "تحمل الالتزام بالسلوك المعرفي",
        "تحسين سلوك الطالب",
        "٢-١-٦ الخبرة",
        "البحث الإلكتروني تصميم من أعمال الطلاب",
        "مبادرة المعلم الصغير",
        "مهارات اختيار الطلاب للدورات من الإنترنت",
        "ورش إدارة الوقت والمعلومات",
        "مباراة الملحنين والخرائط الذهنية",
        "سجل زيارة المكتبة",
        "٢-٢-١-٧ اعتزاز بشق المهم",
        "تراثنا الأصيل معرض",
        "يوم اللغة العربية",
        "القهوة السعودية",
        "تاريخ العمارة السعودية",
        "الرحلات السياحية والوطنية",
        "مسابقة الشعر والأدب الشعبي",
        "مهرجان الثقافات ملتقى",
        "٤-١-١-١ توفير بيئة يسودها الهدوء",
        "سجل الصيانة",
        "مهارات نظام المدرسة",
        "جزء من المصلى (جاهزية المصلى)",
        "سجل لوحات الطوارئ والإرشادات",
        "استبانة رضا مرفق التحسين",
        "٤-١-١-٢ مخطط المدرسة",
        "صور المنحدرات",
        "سجل توزيع الطلاب",
        "تقرير عن مواقع ذوي الاحتياجات",
        "مجموعة دورات المياه لذوي الإعاقة",
        "خطط الإخلاء",
        "٤-١-١-٣ سجل جرد المعامل والعلوم",
        "تقرير سلامة المعامل",
        "توفر طفايات الحريق",
        "جدول استخدام المعامل",
        "تقرير المعمل الحاسب",
        "سجل الإنترنت",
        "٤-١-١-٤ الملاعب الرياضية",
        "غرفة المصادر",
        "نادي الموهبة",
        "ملاءمة البيئة المدرسية",
        "سجل حافلات النقل المدرسي",
        "غرفة الموجه الطلابي",
        "٤-٢-١-١ توفير بيئة بمتطلبات السلامة",
        "سجل أدوات الإطفاء",
        "تقرير تجربة الإخلاء",
        "لوحات مخارج الطوارئ",
        "كاشف الدخان والإنذار",
        "قرار تشكيل لجنة الطوارئ",
        "تقرير خطة الطوارئ",
        "صور مخارج الطوارئ",
        "استبيان الوعي بالأمن والسلامة",
